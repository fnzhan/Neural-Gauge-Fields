...
def config_parser(cmd=None):
    ...
    # parser.add_argument("--infoinv", type=bool, default=True, help='infoinv')
    # parser.add_argument("--infoinv", type=int, default=1, help='infoinv')
    parser.add_argument("--infoinv", action="store_true", help="infoinv")
